...
var FreeEmojis = (() => {
    ...
    function Start() {
        ...
        function replaceEmoji(parseResult, emoji, index) {
            let emojiUrl = `https://cdn.discordapp.com/emojis/${emoji.id}.${emoji.animated ? "gif" : "webp"}?quality=lossless&i=${index}${pluginSettings.useNativeEmojiSize.value ? "" : "&size=48"}`;
